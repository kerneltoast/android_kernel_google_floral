...
#define ERROR_ENABLE_INTER		((int)0x80000300)	/* /< unable to
								 * activate the
								 * interrup */
#define ERROR_READ_CONFIG		((int)0x80000400)	/* /< failed to
								 * read config
								 * memory */
#define ERROR_GET_OFFSET		((int)0x80000500)	/* /< unable to
								 * read an
								 * offset from
								 * memory */
#define ERROR_GET_FRAME_DATA		((int)0x80000600)	/* /< unable to
								 ...
								 * required
								 * frame */
#define ERROR_DIFF_DATA_TYPE		((int)0x80000700)	/* /< FW answers
								 * with an event
								 * that has a
								 * different
								 * address
								 ...
								 * request done
								 * */
#define ERROR_WRONG_DATA_SIGN		((int)0x80000800)	/* /< the
								 * signature of
								 * the host data
								 * is not
								 * HEADER_SIGNATURE
								 * */
#define ERROR_SET_SCAN_MODE_FAIL	((int)0x80000900)	/* /< setting
								 * the scanning
								 * mode failed
								 * (sense on/off
								 * etc...) */
...
#define ERROR_FLASH_NOT_READY		((int)0x80000C00)	/* /< flash
								 ...
								 * ready within
								 * a timeout */
#define ERROR_FW_VER_READ		((int)0x80000D00)	/* /< unable to
								 * retrieve
								 * fw_vers or
								 * the config_id
								 * */
#define ERROR_GESTURE_ENABLE_FAIL	((int)0x80000E00)	/* /< unable to
								 ...
								 * the gesture
								 * */
#define ERROR_GESTURE_START_ADD		((int)0x80000F00)	/* /< unable to
								 * start to add
								 * custom
								 * gesture */
#define ERROR_GESTURE_FINISH_ADD	((int)0x80001000)	/* /< unable to
								 * finish to add
								 * custom
								 * gesture */
#define ERROR_GESTURE_DATA_ADD		((int)0x80001100)	/* /< unable to
								 * add custom
								 * gesture data
								 * */
#define ERROR_GESTURE_REMOVE		((int)0x80001200)	/* /< unable to
								 * remove custom
								 * gesture data
								 * */
...
#define ERROR_NOISE_PARAMETERS		((int)0x80001400)	/* /< unable to
								 ...
								 * parameter in
								 * the IC */
#define ERROR_CH_LEN			((int)0x80001500)	/* /< unable to
								 * retrieve the
								 * force and/or
								 * sense length
								 * */
...
#define ERROR_REQU_COMP_DATA	((int)0x80010000)	/* /< compensation data
							 * request failed */
#define ERROR_REQU_DATA		((int)0x80020000)	/* /< data request
							 * failed */
#define ERROR_COMP_DATA_HEADER	((int)0x80030000)	/* /< unable to retrieve
							 * the compensation data
							 *header */
#define ERROR_COMP_DATA_GLOBAL	((int)0x80040000)	/* /< unable to retrieve
							 * the global
							 * compensation data */
...
#define ERROR_MEMH_READ		((int)0x80070000)	/* /< memh reading
							 * failed */
...
#define ERROR_SS_TUNING		((int)0x800A0000)	/* /< ss tuning failed
							 * */
#define ERROR_LP_TIMER_TUNING	((int)0x800B0000)	/* /< lp timer
							 * calibration failed */
#define ERROR_SAVE_CX_TUNING	((int)0x800C0000)	/* /< save cx data to
							 * flash failed */
...
#define ERROR_CHECK_ECHO_FAIL	((int)0x800E0000)	/* /< unable to retrieve
							 * echo event */
#define ERROR_GET_FRAME		((int)0x800F0000)	/* /< unable to get
							 * frame */
/** @}*/
...
#define ERROR_PROD_TEST_INITIALIZATION	((int)0x84000000) /* /< production
							   * initialization
							   * test failed */
#define ERROR_GET_INIT_STATUS		((int)0x85000000) /* /< mismatch
							   * of the MS or
							  * SS tuning_version */
/** @}*/
